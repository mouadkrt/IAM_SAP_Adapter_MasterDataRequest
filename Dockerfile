...
# docker build -t muis-fuse-sap-adapter:iam_0.0.5 .
# Tag it and push to quay
# docker tag muis-fuse-sap-adapter:iam_0.0.5 quay.io/msentissi/muis-fuse-sap-adapter:iam_0.0.5
# docker push quay.io/msentissi/muis-fuse-sap-adapter:iam_0.0.5
# OR tag it and push to dockerhub
# docker push msentissi/muis-fuse-sap-adapter:iam_0.0.5

# docker run --rm -ti muis-fuse-sap-adapter:iam_0.0.5 bash