...
# docker build -t muis-fuse-sap-adapter:iam_0.0.3 .
# Tag it and push to quay
# docker tag muis-fuse-sap-adapter:iam_0.0.3 quay.io/msentissi/muis-fuse-sap-adapter:iam_0.0.3
# docker push quay.io/msentissi/muis-fuse-sap-adapter:iam_0.0.3
# OR tag it and push to dockerhub
# docker push msentissi/muis-fuse-sap-adapter:iam_0.0.3

# docker run --rm -ti muis-fuse-sap-adapter:iam_0.0.3 bash