...
# docker build -t muis-fuse-sap-adapter:iam_0.0.6 .
# Tag it and push to quay
# docker tag muis-fuse-sap-adapter:iam_0.0.6 quay.io/msentissi/muis-fuse-sap-adapter:iam_0.0.6
# docker push quay.io/msentissi/muis-fuse-sap-adapter:iam_0.0.6
# OR tag it and push to dockerhub
# docker push msentissi/muis-fuse-sap-adapter:iam_0.0.6

# docker run --rm -ti muis-fuse-sap-adapter:iam_0.0.6 bash